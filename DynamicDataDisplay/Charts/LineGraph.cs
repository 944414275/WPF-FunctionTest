...
namespace Microsoft.Research.DynamicDataDisplay
{
	...
	public class LineGraph : PointsGraphBase
	{
		...
		public Brush StrokeNew
		{
			get 
			{ 

				return (Brush)GetValue(StrokeNewProperty);
			}
			set 
			{
				Stroke = value;
				...
				//		LinePen = pen;
				//	}
				//	RaisePropertyChanged("StrokeNew");
				//}

				SetValue(StrokeNewProperty, value);
				RaisePropertyChanged("StrokeNew");
			}
		}

		public static readonly DependencyProperty StrokeNewProperty =
